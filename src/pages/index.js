...
export async function renderHomePage() {
  return `
    ...
    <div class="grid-2" style="margin-bottom: 32px;">
      <a href="/pokemon" data-link class="card" style="cursor:pointer; text-decoration:none;">
        <div class="card-title">포켓몬 도감</div>
        <p style="color: var(--color-text-secondary); font-size: 0.875rem;">
          추천 노력치 · 스탯포인트 분배 · 기술 · 특성 · 파트너 정보
        </p>
      </a>
      <a href="/meta/usage" data-link class="card" style="cursor:pointer; text-decoration:none;">
        <div class="card-title">사용률 통계</div>
        <p style="color: var(--color-text-secondary); font-size: 0.875rem;">
          Pikalytics 기반 현시즌 사용률 실시간 반영
        </p>
      </a>
      <a href="/meta/tier" data-link class="card" style="cursor:pointer; text-decoration:none;">
        <div class="card-title">티어리스트</div>
        <p style="color: var(--color-text-secondary); font-size: 0.875rem;">
          S ~ D 티어 분류 · 카운터 포켓몬 · 추천 운용 방식
        </p>
      </a>
      <a href="/team" data-link class="card" style="cursor:pointer; text-decoration:none;">
...
function renderPokemonCard(p) {
  ...
  return `
    <a href="/pokemon/${p.id}" data-link class="pokemon-card" style="text-decoration:none;">
      <img
        class="pokemon-img"
...
export async function renderPokemonDetailPage(params) {
  ...
  return `
    <div class="breadcrumb">
      <a href="/pokemon" data-link>포켓몬 도감</a>
      <span>›</span>
